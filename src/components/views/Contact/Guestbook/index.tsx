...
const Guestbook = (props: Proptypes) => {
  const { messages, isSubmitting, handleSubmit, isLoading } = props;
  return (
    <div className="mt-10">
      ...
      <Divider />
      <div>
        <div className="flex flex-col pt-2 md:pt-5 border border-neutral-200 rounded w-full">

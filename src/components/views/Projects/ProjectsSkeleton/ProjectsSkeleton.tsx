const ProjectsSkeleton = () => {
  return (
    <>
      <div className="bg-gray-200 dark:bg-neutral-700 rounded-lg w-full h-[250px] md:h-[300px] lg:h-[350px] animate-pulse" />
      <div>
            ...
            return (
              ...
              >
                <div className="block relative rounded-md w-full h-48 overflow-hidden cursor-pointer">
                  <div className="bg-gray-200 dark:bg-neutral-700 w-full h-full object-cover animate-pulse" />
                </div>

                <div className="flex flex-col mt-2 h-28">
                  <div className="flex-grow">
                    <span className="block bg-gray-200 dark:bg-neutral-700 mb-2 rounded-md h-6 font-libre animate-pulse" />
                    <span className="block bg-gray-200 dark:bg-neutral-700 mb-2 rounded-md h-5 font-libre animate-pulse" />
                    <span className="block bg-gray-200 dark:bg-neutral-700 mb-1 rounded-md h-5 font-libre animate-pulse" />
                  </div>

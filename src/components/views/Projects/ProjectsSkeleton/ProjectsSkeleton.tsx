            ...
            return (
              ...
              >
                <div className="block relative rounded-t w-full h-48 overflow-hidden cursor-pointer">
                  <div className="bg-gray-200 w-full h-full object-cover animate-pulse" />
                </div>

                <div className="flex flex-col mt-2 h-28">
                  <div className="flex-grow">
                    <span className="block bg-gray-200 mb-2 h-8 font-libre animate-pulse" />
                    <span className="block bg-gray-200 mb-2 h-4 font-libre animate-pulse" />
                    <span className="block bg-gray-200 mb-1 h-4 font-libre animate-pulse" />
                  </div>
